...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # If threshold by 0, gradient signal should note be propagated to previous layer.
    # In another insight, 'max' gate only backprop the gradient if forward pass activations
    # are bigger than zero. The graident signal that backpropated is the same as 'max' gate output
    # gradient (here is dhidden).
